...
<tbody>
    ...
    <tr>
        <td><p style="color:#777777;">Your mentor should be touching base with you via email shortly. If you do not hear from them within 48 hours please feel free to contact the <a href="<?php echo $store->getPermalink(false, true) ?>">store owner.</a></p></td>
    </tr>
