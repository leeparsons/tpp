...
<?php wp_enqueue_script('tppproduct_dashboard', TPP_STORE_PLUGIN_URL . '/site/assets/js/dashboard/product-ck.js', array('jquery'), 3.5, true); ?>
...
<form method="post" enctype="multipart/form-data" id="product_form">
    ...
    <input type="hidden" value="5" name="product_type" id="product_type">
    ...
    <div class="aside-25">
        <a href="/shop/dashboard/events" class="btn btn-primary">&lt; &lt; Back to Events</a>

        <ul class="product-togglers">
            <li class="first active">The event</li>
            <li>Categories</li>
            <li>About</li>
            <li>Pricing</li>
    ...
    <div class="aside-75">
        ...
        <fieldset>
            ...
            <div class="switch-control form-group bt">
                ...
                <a href="#0" data-step="0" class="step btn-primary btn">Go back to The Event</a>
        ...
        <fieldset>
            <?php include TPP_STORE_PLUGIN_DIR . 'site/views/dashboard/product/images.php'; ?>
        ...
        <fieldset>
            <?php include TPP_STORE_PLUGIN_DIR . 'site/views/dashboard/product/seo.php'; ?>
