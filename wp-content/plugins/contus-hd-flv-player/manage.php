            ...
            <div name=txtHint ></div>
                ...
                if($tables) {
                    ...
                    foreach($tables as $table) {
                        ...
                        if($id1 == '1') { echo "<img src='../wp-content/plugins/".dirname( plugin_basename(__FILE__) )."/arrow.png' alt='move' width='16' height='16' class='handle' /></th>\n";}
...
<select name="plfilter">
    <option value="0" <?php if ($plfilter == '0') echo 'selected="selected"'; ?>><?php _e('--Playlist--', 'hdflv'); ?></option>
